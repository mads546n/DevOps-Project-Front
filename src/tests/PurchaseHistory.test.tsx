...
import PurchaseHistory from './PurchaseHistoryMock';
...
describe('PurchaseHistory Component (Use Case #11)', () => {
  it('shows purchase history after navigating through profile', () => {
    ...
    // Events
    const profileButton = screen.getByRole<HTMLButtonElement>('button', { name: /my profile/i });
    fireEvent.click(profileButton);

    const historyButton = screen.getByRole<HTMLButtonElement>('button', { name: /my purchase history/i });
